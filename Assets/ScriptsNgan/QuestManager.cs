...
public class QuestManager : MonoBehaviour
{
    ...
    public IEnumerator ShowCompletionNotification()
    {
        ...
        {
            Debug.LogError("victoryPanel is not assigned!");
        }
        if (victoryText == null)
        {
            Debug.LogError("victoryText is not assigned!");
        }
        ...
        if(currentScene == "Backup Scene 2")
        {
            SceneManager.LoadScene("Backup Scene 3");
        }
        if(currentScene == "Backup Scene 3")
        {
            SceneManager.LoadScene("Backup Scene 4");
        }
        if(currentScene == "Backup Scene 4")
        {
        ...
        else if (currentScene == "Boss")
        {
            ...
            if (menuManager != null)
            {
                StartCoroutine(menuManager.EndGameAndReturnToMenu());
            }
            else
            {
